...
class DisplaySPIImg():
    ...
    def create_panels(self):
        ...
        ax_bar_img = fig.add_subplot(gspec[1,0], aspect = 1/22)
...
drc = "/cds/data/drpsrcf/mfx/mfxlv4920/scratch/cwang31/psocake/r0042"
fl_npy = "mfxlv4920_0042_epix10k2M_max.npy"
path_npy = os.path.join(drc, fl_npy)
...
# Dispaly an image...
disp_manager = DisplaySPIImg(img, figsize = (12, 8))
disp_manager.show(title = '', is_save = False)
